...
void _courseSerialize(
  ...
  writer.writeString(offsets[0], object.thumbnailPath);
...
Course _courseDeserialize(
  ...
  final object = Course();
  object.id = id;
  object.thumbnailPath = reader.readString(offsets[0]);
...
extension CourseQueryFilter on QueryBuilder<Course, Course, QFilterCondition> {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathEqualTo(
    String value, {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Course, Course, QAfterFilterCondition> thumbnailPathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'thumbnailPath',
        value: '',
...
extension CourseQuerySortBy on QueryBuilder<Course, Course, QSortBy> {
  QueryBuilder<Course, Course, QAfterSortBy> sortByThumbnailPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailPath', Sort.asc);
    });
  }

  QueryBuilder<Course, Course, QAfterSortBy> sortByThumbnailPathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CourseQuerySortThenBy on QueryBuilder<Course, Course, QSortThenBy> {
  ...
  QueryBuilder<Course, Course, QAfterSortBy> thenByThumbnailPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailPath', Sort.asc);
    });
  }

  QueryBuilder<Course, Course, QAfterSortBy> thenByThumbnailPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailPath', Sort.desc);
    });
  }
...
extension CourseQueryWhereDistinct on QueryBuilder<Course, Course, QDistinct> {
  QueryBuilder<Course, Course, QDistinct> distinctByThumbnailPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CourseQueryProperty on QueryBuilder<Course, Course, QQueryProperty> {
  ...
  QueryBuilder<Course, String, QQueryOperations> thumbnailPathProperty() {
    return QueryBuilder.apply(this, (query) {
